...
namespace AC
{
	...
	[System.Serializable]
	public class EnableCharacter : Action
	{
		
		// Declare properties here
		public override ActionCategory Category { get { return ActionCategory.Custom; }}
		public override string Title { get { return "EnableCharacter"; }}
		...
		public override float Run ()
		{
			...
			{
				isRunning = true;
				objectToAffect.transform.GetChild(0).gameObject.SetActive(true);
        ...
        public override void ShowGUI (List<ActionParameter> parameters)
		{
            ...
            {
				objectToAffect = (GameObject)EditorGUILayout.ObjectField("Character to affect: ", objectToAffect, typeof(GameObject), true);
